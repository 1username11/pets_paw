  ...
  <div class="flex flex-col space-y-2.5">
    ...
    <div class="min-h-[780px] bg-white rounded-2xl p-5">
      ...
      <div>
        ...
        <div class="flex justify-center items-center mx-auto bg-white w-[258px] h-[88px] rounded-2xl mt-[-40px] relative space-x-1">
          <button class="bg-[#97EAB9] w-[80px] h-[80px] rounded-l-2xl">
